...
import { GeoPoint, Person } from '@/types/domain';
import { MapCameraCommand, MapCameraPosition, MapStyle } from '@/types/map';
import { trailGradient } from '@/utils/color';
...
/**
 * Google Maps live view: 3D buildings, tiltable/rotatable camera, and every
 * crew member with a fading motion trail behind them.
